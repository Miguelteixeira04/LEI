...
class Agregador
{
    ...
    static void Main()
    {
        TcpListener listener = new TcpListener(IPAddress.Any, 4500);
        listener.Start();
        Console.WriteLine("Agregador aguardando conexões na porta 4500...\n");
        // Caminho para a pasta 
        string basePath = "C:/Users/mikeb/source/repos/SD_PL3_78321_78282_78806/Agregador456/Data";
        // Carregar dados dos arquivos CSV
        dados_humidade = File.ReadAllLines(Path.Combine(basePath, "Dados-Humidade_456.xlsx"));
        dados_ondulacao = File.ReadAllLines(Path.Combine(basePath, "Dados-Ondulação_456.xlsx"));
        dados_pressao = File.ReadAllLines(Path.Combine(basePath, "Dados-Pressão_456.xlsx"));
        dados_temperatura_Agua = File.ReadAllLines(Path.Combine(basePath, "Dados-Temperatura_Agua_456.xlsx"));
        dados_temperatura_Ar = File.ReadAllLines(Path.Combine(basePath, "Dados-Temperatura_Ar_456.xlsx"));
        dados_vento = File.ReadAllLines(Path.Combine(basePath, "Dados-Vento_456.xlsx"));
    ...
    private static void ProcessarDados(string[] dados, string wavyID)
    {
        ...
        for (int i = 0; i < dados.Length; i++)
        {
            ...
            string caminhoArquivo = $"C:/Users/mikeb/source/repos/SD_PL3_78321_78282_78806/Agregador456/Data/Dados-{tipoDado}_456.xlsx";
    ...
    {
        string caminhoArquivo = "C:/Users/mikeb/source/repos/SD_PL3_78321_78282_78806/Agregador456/Data/Wavys associadas_456.xlsx";
        object fileLock;
        // Obter ou criar um objeto de bloqueio para este arquivo
        lock (dictionaryLock)
        {
