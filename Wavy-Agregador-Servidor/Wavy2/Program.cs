...
class Wavy
{
    ...
    static void Main()
    {
        ...
        string basePath = "C:/Users/mikeb/source/repos/SD_PL3_78321_78282_78806/Wavy2/Data";
    ...
    static void EnviarDados()
    {
        ...
        int slotInCycle = 1; // 0 = first position
        ...
        while (contador < totalDados)
        {
            ...
            if (resumingFromPause)
            {
                ...
                Thread.Sleep(5000+1000); // Small delay to ensure all Wavys have processed the resume
            }
